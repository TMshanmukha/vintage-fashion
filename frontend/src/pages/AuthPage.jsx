                    ...
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      {!isLogin && (
                        <button
                          ...
                          className="text-xs font-bold text-pink-600 hover:text-pink-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1 transition"
                        >
                          {sendingOtp ? (
                            ...
                            <span className="text-gray-400 font-medium text-[11px]">Resend in {otpCountdown}s</span>
                          ) : otpSent ? (
                            <span className="text-[11px]">Resend Code</span>
                          ) : (
                            <span className="text-[11px]">Get Code →</span>
                          )}
                        </button>
                      )}
                    </div>
