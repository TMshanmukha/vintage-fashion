            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  link: "mailto:support@vintagefashion.in",
                  isLink: true,
                },
              ].map(({ icon, title, desc, isLink, link }) => (
                <div key={title} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    {isLink ? (
                      <a href={link} className="text-sm text-gray-500 hover:text-pink-600 transition-colors">
                        {desc}
                      </a>
                    ) : (
